...
const Contact = () => {
  return (
    <div className="flex flex-wrap items-center justify-center p-12 bg-black text-white  shadow-lg w-full" style={{ fontFamily: 'Courier New, Courier, monospace' }}>
      {/* Left Section */}
      <div className="flex-1 min-w-[300px] text-left pr-10">
        <h1 className="text-6xl font-bold uppercase leading-tight">
          Let&apos;s <br />
          <span className="text-yellow-500">Create</span> Something <br /> Amazing!
        </h1>
        <p className="mt-6 text-2xl text-gray-500">
        <span className="text-yellow-500"> Ready to bring your ideas to life? </span>
     ...
     <div className="flex-1 min-w-[400px] text-center p-8 bg-gray-800 rounded-xl shadow-md">
        {/* Contact Details */}
        <div className="mb-6">
          <h3 className="text-3xl font-bold text-yellow-500 uppercase tracking-wide">Get In Touch</h3>
        ...
        {/* Social Icons */}
        <div>
          <h3 className="text-2xl font-semibold text-yellow-500 mb-6 uppercase tracking-wide">Connect With Me</h3>
